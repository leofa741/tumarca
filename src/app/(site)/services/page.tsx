      ...
      <section className="container mx-auto px-6 py-20 md:py-28 lg:py-32">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="bg-white/8 backdrop-blur-md rounded-2xl p-7 shadow-xl border border-white/10 hover:shadow-amber-500/20 transition-all duration-300 transform hover:-translate-y-1">
            ...
            <h3 className="text-white font-bold text-2xl mb-4">Chat  IA</h3>
            <p className="text-gray-300 text-sm mb-5 leading-relaxed">
              Chat IA para conectar con tus clientes al instante. Implementamos soluciones de chat personalizadas para tu sitio web, con funciones avanzadas de mensajería, notificaciones y gestión de conversaciones. 
           </p>
            <ul className="space-y-3">
