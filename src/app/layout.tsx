      ...
      >
        ...
        <LoadingProvider>
          ...
          <a
            ...
            className="fixed bottom-6 left-6 z-50 flex items-center justify-center bg-green-500 text-white p-0 rounded-full shadow-lg hover:scale-130 hover:shadow-xl transition-all duration-300 ease-in-out animate-pulse-slow"
            target="_blank"
