...
export const metadata: Metadata = {
  title: {
    default: 'Sistema de Control de Acceso para Gimnasios | Tu Marca AR',
  ...
  keywords: ['Sistema de control de acceso', 'Gimnasios', 'RFID', 'Fraudes', 'Ahorro operativo', 'Experiencia premium', 'Instalación en 7 días'],
  openGraph: {
