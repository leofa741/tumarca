...
export default function Home() {
  ...
  return (
    <main
     ...
     className={`min-h-screen bg-gradient-to-b from-gray-950 via-gray-900 to-black text-white overflow-x-hidden ${playfair.variable} ${inter.className}`}>
      ...
      {/* Navigation Dots - Indicador de sección activa */}
      <nav className="fixed right-6 top-1/2 -translate-y-1/2 z-40 hidden lg:flex flex-col gap-3">
        {['hero', 'serviciosHome', 'portfolio', 'cta'].map((section) => (
          <a
            key={section}
            href={`#${section}`}
            className={`group relative w-3 h-3 rounded-full transition-all duration-300 ${activeSection === section
      ...
      {/* HERO SECTION - Integración premium con IntroHome */}
      <section id="hero" className="relative min-h-screen flex items-center justify-center px-6 pt-20">
        ...
        <div className="absolute inset-0 overflow-hidden">
          <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[800px] h-[800px] bg-gradient-to-r from-amber-500/20 to-purple-500/20 rounded-full blur-3xl animate-pulse" />
        </div>
      ...
      {/* SECCIÓN SERVICIOS - Rediseño premium */}
      <section
        ref={serviciosRef}
        id="serviciosHome"
      ...
      >
        <div className="max-w-7xl mx-auto">
          ...
          {/* Grid de servicios con ValorDestacado mejorado */}
          <motion.div
              ...
              >
                ...
                <div className="relative bg-white/5 backdrop-blur-xl rounded-3xl p-1 border border-white/10">
                  <ValorDestacado
                    ...
                    alt={service.alt}
                    delay={service.delay}
                    // Props adicionales para el diseño premium (si tu componente lo soporta)
      ...
      {/* SECCIÓN PORTFOLIO / IMAGE ACCORDION */}
